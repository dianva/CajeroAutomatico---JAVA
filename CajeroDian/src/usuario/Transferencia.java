...
public class Transferencia extends javax.swing.JFrame {
     ...
     */
    public Transferencia(PanelUsuario panelUsuario) {
        initComponents();
        ventanas();
    ...
    private void initComponents() {
        ...
        txfRetira.setBounds(280, 110, 120, 40);
        ...
        fasdf.setBackground(new java.awt.Color(51, 255, 0));
        ...
        btnBorrar.setBackground(new java.awt.Color(51, 255, 0));
        ...
        txfDestino.setBounds(120, 110, 110, 40);

        jLabel3.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("CANTIDAD:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(280, 80, 120, 30);
        ...
        jLabel2.setBounds(400, 120, 34, 20);

        lblTransferir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgDinero/transferir.PNG"))); // NOI18N
        getContentPane().add(lblTransferir);
        lblTransferir.setBounds(90, 60, 350, 290);
...
//Paso 2: Ejecutar una consulta
                try {
                    ...
                    int nCuenta = Integer.parseInt(txfDestino.getText());
                    String sql = "SELECT num_cuenta FROM cuenta where num_cuenta='" + nCuenta + "'";
                    rs = sentencia.executeQuery(sql);
                    rs.first();
                    ncuenta = rs.getInt("num_cuenta");
                } catch (SQLException ex) {
                    txfDestino.setText("ERROR");
                } catch (java.lang.NumberFormatException ex) {
                    txfDestino.setText("ERROR");

                }
                ResultSet rs = null;
                if (txfDestino.getText().equals("ERROR")) {
                    JOptionPane.showMessageDialog(null, "Destino incorrecto.");
                } else {
                    try {
                        Statement sentencia = conexion.createStatement();
                    } catch (SQLException ex) {
                    ...
                    int retirar = 0;
                    try {
                        retirar = Integer.parseInt(txfRetira.getText());
        ...
        if (txfRetira.getText().equals("ERROR")) {
            JOptionPane.showMessageDialog(null, "No dispone de la cantidad introducida");
        } else {
            //REALIZAR EL INGRESO
            conexion = Conexion.mySQL("cajero", "root", "");
            if (conexion != null) {
...
//Paso 2: Ejecutar una consulta
                ...
                int saldo = SaldoDestino();

                try {
                    int ingresar = Integer.parseInt(txfRetira.getText());
                    int suma = saldo + ingresar;
                    String sql = "UPDATE `cuenta` SET `saldo`=" + suma + " WHERE num_cuenta='" + Integer.parseInt(txfDestino.getText()) + "'";

                    PreparedStatement pst = conexion.prepareStatement(sql);
                    int retorno = pst.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Transferido " + ingresar + ".00€ a la cuenta destino.");
                    panelUsuario.principal.insertarMovimiento(ingresar, 1, Integer.parseInt(txfDestino.getText()), suma);
                } catch (SQLException e) {
                    JOptionPane.showMessageDialog(null, "ERROR" + e);
...
//Paso 2: Ejecutar una consulta
            try {
                ResultSet rs = null;
                Statement sentencia = conexion.createStatement();
                String sql = "SELECT saldo FROM cuenta where num_cuenta='" + txfDestino.getText() + "'"; //hacer un select pasando por las variables publicas que tengo en las frame previas
                rs = sentencia.executeQuery(sql);
