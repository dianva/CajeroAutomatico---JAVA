...
public class Donacion extends javax.swing.JFrame {
     ...
     */
    public Donacion(PanelUsuario panelUsuario) {
        initComponents();
        ventanas();
    ...
    private void ventanas() {
        ...
        lblGracias.setVisible(false); //este label se muestra cuando insertamos la tarjeta
    ...
    private void initComponents() {
        ...
        fasdf.setBackground(new java.awt.Color(255, 102, 102));
        ...
        lblGracias.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/gracias.gif"))); // NOI18N
        getContentPane().add(lblGracias);
        lblGracias.setBounds(60, 90, 380, 270);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/donacion.PNG"))); // NOI18N
        getContentPane().add(jLabel3);
        jLabel3.setBounds(90, 64, 350, 290);
